...
def get_center_loss(features, labels, features_target, labels_target, alpha, num_classes):
...
###########################################################################
    ...
    centers1=tf.unsorted_segment_mean(features_target,labels_target,num_classes)
